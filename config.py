...
_C.DATA.BATCH_SIZE = 3
# Frame length for a single video, could be overwritten by command line argument
_C.DATA.FRAME_LEN = 12
...
_C.TRAIN.EPOCHS = 500 # 300 for protocol 4
...
_C.TRAIN.LR_SCHEDULER.DECAY_EPOCHS = 150#60
# LR decay rate, used in StepLRScheduler
_C.TRAIN.LR_SCHEDULER.DECAY_RATE = 0.5#0.1

# Optimizer
_C.TRAIN.OPTIMIZER = CN()
_C.TRAIN.OPTIMIZER.NAME = 'adamw' #'sgd'
# Optimizer Epsilon
...
def update_config(config, args):
    ...
    if args.frame_len:
        config.DATA.FRAME_LEN = args.frame_len
    if args.data_path:
